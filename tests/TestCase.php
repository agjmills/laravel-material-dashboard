...
use Agjmills\LaravelMaterialDashboard\MaterialDashboard;
use Agjmills\LaravelMaterialDashboard\Menu\Builder;
use Agjmills\LaravelMaterialDashboard\Menu\ActiveChecker;
use Agjmills\LaravelMaterialDashboard\Menu\Filters\GateFilter;
use Agjmills\LaravelMaterialDashboard\Menu\Filters\HrefFilter;
use Illuminate\Contracts\Auth\Access\Gate as GateContract;
use Agjmills\LaravelMaterialDashboard\Menu\Filters\ActiveFilter;
use Agjmills\LaravelMaterialDashboard\Menu\Filters\ClassesFilter;
use Agjmills\LaravelMaterialDashboard\Menu\Filters\SubmenuFilter;
...
class TestCase extends PHPUnit_Framework_TestCase
{
    ...
    protected function makeMaterialDashboard()
    {
        return new MaterialDashboard($this->getFilters(), $this->getDispatcher(), $this->makeContainer());
    }
